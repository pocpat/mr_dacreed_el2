  ...
  return (
    <form onSubmit={handleSubmit} className="m-0">
      ...
      <div className="w-82 dropdown dropdown-top flex content-center justify-center rounded-sm">
        ...
        >
          <li>
            <a onClick={addNewAnswer}> Answers Add more answer boxes </a>
          </li>
          <li>
            <a onClick={() => setIsModal4Open(true)}>
              Media Upload or embed with a link
            </a>{" "}
            {/* Open modal on media click */}{" "}
          </li>
          <li>
            <a>Commentary Add commentary for course</a>
          </li>
          <li>
            <a>Guidance Add guidance for course</a>
          </li>
        </ul>
      </div>
      {isModal4Open && (
