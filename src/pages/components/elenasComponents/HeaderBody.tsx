...
const HeaderBody = () => {
  ...
  return (
    <>
       {/* <div
        className="border-box flex flex-col items-center justify-start  bg-[#DFDFDF] p-4 "
 ...
 {/* Title */}
        {/* <div className="form-control w-full">
          ...
          <textarea
            ...
            className="shadow-inner shadow-md textarea-bordered textarea textarea-xs w-full rounded-sm" */}
            {/* style={{ width: "100%" }} */}
             {/* z-index='-1'
             readOnly= {false}
          ></textarea>
